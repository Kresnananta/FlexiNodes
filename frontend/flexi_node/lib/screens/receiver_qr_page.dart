...
class ReceiverQrPage extends StatelessWidget {
  const ReceiverQrPage({super.key});
    ...
    return AnimatedBuilder(
      ...
      builder: (context, _) {
        ...
        return Scaffold(
          ...
          appBar: const FlexiAppBar(title: 'Receiver Pickup QR'),
          body: SafeArea(
            top: false,
            child: ListView(
                  ...
                  child: Column(
                    children: [
                      const CircleAvatar(
                        ...
                        child: Icon(Icons.person_outline, color: FlexiColors.primary, size: 38),
                      ),
                      const SizedBox(height: 14),
                      const Text('Receiver Pickup QR', textAlign: TextAlign.center, style: TextStyle(fontSize: 24, fontWeight: FontWeight.w900)),
                      const SizedBox(height: 6),
                      Text('Show this QR to the mitra cashier to release package ${store.orderId}.', textAlign: TextAlign.center, style: const TextStyle(color: FlexiColors.muted, fontSize: 13, height: 1.35)),
                      ...
                      Container(
                        ...
                        child: QrImageView(data: store.receiverQrPayload, version: QrVersions.auto, size: 230, backgroundColor: Colors.white),
                      ),
                      const SizedBox(height: 18),
